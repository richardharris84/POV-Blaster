    ...
    if '</body>' in html:
        ...
        if 'id="pov-blaster-footer"' not in html:
            footer_markup = (
                ...
                '👨‍💻🧠🤖🤯 Built by: '
                '<span class="pov-blaster-author">Richard Harris</span> + '
                '<a class="pov-blaster-copilot" href="https://github.com/features/copilot" '
                ...
                '#pov-blaster-footer .pov-blaster-author { color: #28a9ff; '
                'border-bottom: 3px solid #28a9ff; padding-bottom: 2px; }\n'
                '#pov-blaster-footer .pov-blaster-copilot { color: #ffffff; '
                'text-decoration: none; }\n'
                '@media (max-width: 700px) { #pov-blaster-footer { font-size: 13px; '
