...
def npc_frame(spec, role, action, frame):
    ...
    if dying:
        bob += int(progress * 28)
    if role == "marshmallow":
        body = (10, 22 + bob, 66, 88 + bob); draw.rounded_rectangle(body, 12, fill=cream, outline=outline, width=4)
        draw.ellipse((20, 50 + bob, 34, 65 + bob), fill=(255, 213, 231), outline=outline, width=2)
        draw.ellipse((42, 50 + bob, 56, 65 + bob), fill=(255, 213, 231), outline=outline, width=2)
        draw.ellipse((29, 42 + bob, 36, 50 + bob), fill=outline); draw.ellipse((44, 42 + bob, 51, 50 + bob), fill=outline)
        draw.ellipse((31, 64 + bob, 45, 72 + bob), fill=light, outline=outline, width=2)
        draw.line((22, 77 + bob, 15, 104), fill=cream, width=11); draw.line((54, 77 + bob, 61, 104), fill=cream, width=11)
    elif role == "doughnut":
        frosting = (238, 78, 143)
        draw.ellipse((9, 22 + bob, 67, 84 + bob), fill=mid, outline=outline, width=4)
        draw.ellipse((16, 27 + bob, 60, 70 + bob), fill=frosting, outline=(154, 43, 105), width=3)
        draw.ellipse((28, 40 + bob, 48, 60 + bob), fill=spec["bg"], outline=outline, width=3)
        for x, y in ((22, 37), (48, 33), (19, 55), (53, 56), (37, 29)): draw.rectangle((x, y + bob, x + 5, y + 2 + bob), fill=light)
        draw.line((18, 76 + bob, 15, 99), fill=mid, width=7); draw.line((58, 76 + bob, 61, 99), fill=mid, width=7)
    elif role == "gingerbread":
        draw.rounded_rectangle((23, 10 + bob, 53, 38 + bob), 5, fill=mid, outline=outline, width=3)
        draw.rectangle((18, 38 + bob, 58, 80 + bob), fill=mid, outline=outline, width=3)
        draw.line((23, 43 + bob, 53, 43 + bob), fill=cream, width=3); draw.line((23, 74 + bob, 53, 74 + bob), fill=cream, width=3)
        draw.line((33, 50 + bob, 28, 73 + bob), fill=cream, width=2); draw.line((43, 50 + bob, 48, 73 + bob), fill=cream, width=2)
        draw.rectangle((29, 21 + bob, 34, 26 + bob), fill=cream); draw.rectangle((42, 21 + bob, 47, 26 + bob), fill=cream)
        draw.line((25, 79 + bob, 18, 104), fill=mid, width=10); draw.line((51, 79 + bob, 58, 104), fill=mid, width=10)
    elif role == "vampire":
        draw.ellipse((26, 10 + bob, 50, 38 + bob), fill=light, outline=outline, width=3)
        draw.polygon([(27, 34 + bob), (49, 34 + bob), (66, 98 + bob), (10, 98 + bob)], fill=deep, outline=outline)
        draw.polygon([(27, 34 + bob), (38, 48 + bob), (49, 34 + bob), (59, 91 + bob), (17, 91 + bob)], fill=(116, 17, 43), outline=outline)
        draw.polygon([(28, 34 + bob), (38, 48 + bob), (48, 34 + bob)], fill=cream, outline=outline)
        draw.rectangle((31, 25 + bob, 35, 29 + bob), fill=outline); draw.rectangle((41, 25 + bob, 45, 29 + bob), fill=outline)
        draw.polygon([(33, 35 + bob), (37, 43 + bob), (38, 37 + bob), (42, 43 + bob), (45, 35 + bob)], fill=cream)
    elif role == "bear":
        ...
        draw.polygon([(15, 35 + bob), (13, 10 + bob), (29, 23 + bob), (47, 23 + bob), (63, 10 + bob), (61, 35 + bob)], fill=mid, outline=outline)
        draw.ellipse((11, 28 + bob, 65, 85 + bob), fill=mid, outline=outline, width=4)
        draw.polygon([(18, 48 + bob), (58, 48 + bob), (51, 78 + bob), (25, 78 + bob)], fill=deep, outline=outline)
        draw.rectangle((23, 38 + bob, 32, 47 + bob), fill=light); draw.rectangle((44, 38 + bob, 53, 47 + bob), fill=light)
        draw.rectangle((29, 49 + bob, 47, 56 + bob), fill=light, outline=outline, width=2)
        draw.line((24, 78 + bob, 15, 104), fill=mid, width=11); draw.line((52, 78 + bob, 61, 104), fill=mid, width=11)
    elif role == "deer":
        ...
        cap = (37, 61, 39)
        skin = (226, 145, 105)
        skin_shadow = (177, 83, 65)
        trousers = (54, 45, 40)
        boot = (111, 79, 48)
        hat_shift = (frame % 3) - 1
        y = bob
        # Broad cap, ear flaps, and the rounded face establish the reference silhouette.
        draw.ellipse((13 + hat_shift, 6 + y, 61 - hat_shift, 31 + y), fill=cap, outline=outline, width=3)
        draw.rectangle((17 + hat_shift, 17 + y, 57 - hat_shift, 25 + y), fill=cap)
        draw.polygon([(12 + hat_shift, 22 + y), (64, 22 + y), (60, 28 + y), (15, 28 + y)], fill=cap, outline=outline, width=2)
        draw.rectangle((11 + hat_shift, 24 + y, 20 + hat_shift, 43 + y), fill=cap, outline=outline, width=2)
        draw.rectangle((56 - hat_shift, 24 + y, 64 - hat_shift, 42 + y), fill=cap, outline=outline, width=2)
        draw.ellipse((20, 26 + y, 56, 51 + y), fill=skin, outline=outline, width=3)
        draw.rectangle((24, 31 + y, 52, 35 + y), fill=skin_shadow)
        draw.ellipse((20, 37 + y, 27, 45 + y), fill=skin)
        draw.ellipse((49, 37 + y, 56, 45 + y), fill=skin)
        draw.rectangle((27, 35 + y, 32, 40 + y), fill=cream, outline=outline, width=1)
        draw.rectangle((44, 35 + y, 49, 40 + y), fill=cream, outline=outline, width=1)
        draw.rectangle((29, 36 + y, 32, 40 + y), fill=outline); draw.rectangle((44, 36 + y, 47, 40 + y), fill=outline)
        draw.ellipse((34, 37 + y, 43, 46 + y), fill=(205, 76, 61), outline=outline, width=1)
        draw.arc((31, 40 + y, 47, 49 + y), 15, 165, fill=outline, width=2)
        # Plaid jacket, cream shirt, suspenders, trousers, and heavy boots.
        draw.polygon([(18, 48 + y), (31, 44 + y), (45, 44 + y), (58, 48 + y), (64, 77 + y), (49, 83 + y), (27, 83 + y), (12, 77 + y)], fill=jacket, outline=outline, width=3)
        for x in (22, 31, 40, 49): draw.line((x, 49 + y, x + 4, 79 + y), fill=plaid, width=2)
        for row in (55, 64, 73): draw.line((17, row + y, 57, row + y), fill=plaid, width=2)
        draw.polygon([(29, 49 + y), (47, 49 + y), (46, 69 + y), (30, 69 + y)], fill=cream, outline=outline, width=2)
        draw.line((27, 49 + y, 31, 80 + y), fill=light, width=2); draw.line((49, 49 + y, 45, 80 + y), fill=light, width=2)
        draw.polygon([(25, 78 + y), (38, 76 + y), (38, 96 + y), (20, 96 + y)], fill=trousers, outline=outline, width=3)
        draw.polygon([(38, 76 + y), (51, 78 + y), (57, 96 + y), (39, 96 + y)], fill=trousers, outline=outline, width=3)
        draw.line((38, 80 + y, 38, 94 + y), fill=outline, width=2)
        draw.line((23, 91 + y, 16, 104), fill=boot, width=9); draw.line((49, 91 + y, 58, 104), fill=boot, width=9)
        draw.rectangle((11, 101, 29, 107), fill=boot, outline=outline, width=2); draw.rectangle((51, 101, 70, 107), fill=boot, outline=outline, width=2)
        draw.line((20, 76 + y, 8, 90 + y), fill=skin, width=6); draw.line((55, 76 + y, 67, 89 + y), fill=skin, width=6)
    elif role == "drone":
        draw.ellipse((10, 31 + bob, 66, 76 + bob), fill=deep, outline=outline, width=4)
        draw.ellipse((25, 39 + bob, 51, 66 + bob), fill=(224, 62, 48), outline=light, width=3)
        draw.ellipse((31, 45 + bob, 45, 59 + bob), fill=cream)
        draw.line((22, 34 + bob, 16, 15 + bob), fill=light, width=3); draw.ellipse((13, 11 + bob, 19, 17 + bob), fill=light)
        draw.line((54, 34 + bob, 60, 15 + bob), fill=light, width=3); draw.ellipse((57, 11 + bob, 63, 17 + bob), fill=light)
        for points in (((12, 63 + bob), (4, 78 + bob)), ((64, 63 + bob), (72, 78 + bob)), ((20, 71 + bob), (14, 88 + bob)), ((56, 71 + bob), (62, 88 + bob))): draw.line(points, fill=mid, width=6)
    elif role == "overlord":
        draw.polygon([(38, 4 + bob), (48, 18 + bob), (62, 10 + bob), (57, 34 + bob), (67, 48 + bob), (57, 91 + bob), (38, 99 + bob), (19, 91 + bob), (9, 48 + bob), (19, 34 + bob), (14, 10 + bob), (28, 18 + bob)], fill=mid, outline=outline)
        draw.ellipse((27, 27 + bob, 49, 51 + bob), fill=deep, outline=light, width=3)
        draw.ellipse((33, 34 + bob, 43, 45 + bob), fill=cream)
        draw.rectangle((25, 53 + bob, 51, 60 + bob), fill=light, outline=outline, width=2)
        draw.line((25, 61 + bob, 14, 92), fill=light, width=8); draw.line((51, 61 + bob, 62, 92), fill=light, width=8)
    elif role == "ghost":
        draw.ellipse((18, 12 + bob, 58, 57 + bob), fill=light, outline=outline, width=4)
        draw.polygon([(18, 49 + bob), (58, 49 + bob), (67, 96 + bob), (53, 84 + bob), (42, 103 + bob), (30, 86 + bob), (13, 99 + bob)], fill=mid, outline=outline)
        draw.ellipse((28, 29 + bob, 35, 38 + bob), fill=deep); draw.ellipse((43, 29 + bob, 50, 38 + bob), fill=deep)
        draw.polygon([(29, 58 + bob), (48, 58 + bob), (43, 75 + bob), (33, 75 + bob)], fill=cream)
    else:
